...
public class XMPRepository : RepositoryService<XMPProfile>
{
    ...
    public override IReadOnlyCollection<XMPProfile> SelectComponent(XMPProfile componentHelper)
    {
        if (_context.XMPProfiles is null || componentHelper is null) return Enumerable.Empty<XMPProfile>().ToImmutableList();
