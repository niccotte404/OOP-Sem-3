...
public class CPUDecompositor : ICPUBuilder
{
    ...
    public CPUDecompositor(CPU cpu)
    {
        _cpu = cpu;
        _coreAmount = _cpu.CoreAmount;
        _coreFrequency = _cpu.CoreFrequency;
        _igpu = _cpu.IGPU;
        _socket = _cpu.Socket;
        _supportedMemoryFrequency = _cpu.SupportedMemoryFrequency;
        _tdp = _cpu.TDP;
        _powerConsumption = _cpu.PowerConsumption;
    }
